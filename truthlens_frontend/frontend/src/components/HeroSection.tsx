...
const HeroSection = () => {
  ...
  // Initialize Streamlit when component mounts
  useEffect(() => {
    if (window.Streamlit) {
  ...
  // Handle fact-checking submission
  const handleFactCheck = () => {
    ...
    switch (activeTab) {
      case "text":
        const textArea = document.getElementById("tl-input-text") as HTMLTextAreaElement;
        contentToAnalyze = textArea?.value || "";
        break;
      case "url":
        const urlInput = document.getElementById("tl-input-url") as HTMLInputElement;
        contentToAnalyze = urlInput?.value || "";
        break;
      case "file":
        // Handle file upload later
        contentToAnalyze = "File upload feature coming soon";
        break;
    }
    ...
    // Reset loading after a delay (analysis will happen in Python)
        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="max-w-2xl mx-auto bg-card rounded-xl shadow-lg p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              >
                {isAnalyzing ? "🔍 Analyzing..." : "Start Fact-Checking"}
              </Button>
